# ============================================
# Multi-stage Dockerfile for Task Execution Service
...
LABEL org.opencontainers.image.title="Task Execution Service" \
      org.opencontainers.image.description="Priority-based task orchestration service" \
      org.opencontainers.image.version="${APP_VERSION}" \
      org.opencontainers.image.vendor="Paklog" \
      org.opencontainers.image.authors="Paklog Engineering Team" \
      org.opencontainers.image.source="https://github.com/paklog/task-execution-service" \
